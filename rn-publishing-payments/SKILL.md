...
1. **Apple's 30% rule**: ANY digital good/service consumed inside the app MUST go through IAP. Subscriptions, premium tiers, in-app currency, unlock-feature one-shots — all IAP. Bypassing this = banishment from the App Store (guideline 3.1.1).
