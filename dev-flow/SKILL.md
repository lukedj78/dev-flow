...
|---|---|---|---|
| `next` (default if missing) | existing | `design-md-to-app` | (this file) |
...
- `scaffolded` → invoke `rn-add-screen` (UI) or `rn-module-add` (backend/infra) — Wave 2/3
- `feature_complete` → invoke `rn-eas-deploy` — Wave 3
