...
TAXONOMY: dict[str, tuple[str, str]] = {
    # --- core (8): stack-agnostic, used by every stack -----------------------
    ...
    "registry-intake":              ("core", "operative"),
    # --- web (18): Next.js 16 App Router ------------------------------------
    ...
    "iframe-canvas":                ("web", "knowledge"),
    "launch-audit":                 ("web", "operative"),
