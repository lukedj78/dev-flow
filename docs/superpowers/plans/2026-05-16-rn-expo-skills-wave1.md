...
import { useUser } from "@/lib/auth"; // your auth hook (rn-backend-supabase later)
...
Knowledge skills: `rn-fundamentals`, `rn-components-apis` (Wave 2), `rn-styling`, `rn-expo-router`, `rn-data-fetching` (Wave 2), `rn-animations-gestures` (Wave 3), `rn-push-notifications` (Wave 3), `rn-backend-supabase` (Wave 3), `rn-eas-build-submit-update` (Wave 3), `rn-publishing-payments` (Wave 3).
